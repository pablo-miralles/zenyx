 ...
 * core/underline en Core no pinta control en el toolbar (solo eventos de teclado).
 */
...
registerFormatType( FORMAT_NAME, {
	title: __( 'Subrayado', 'zenyx' ),
	tagName: 'u',
	// WP 6.9+: obligatorio para elementos sin clase (evita "Format class names must be a string…").
	className: null,
	edit: UnderlineEdit,
} );
